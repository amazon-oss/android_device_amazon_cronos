...
DEVICE_PATH := device/amazon/cronos

# BLuetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := $(DEVICE_PATH)/bluetooth

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := cronos

# HIDL
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest_cronos.xml

# Kernel
TARGET_KERNEL_CONFIG := cronos_defconfig
...
include vendor/amazon/cronos/BoardConfigVendor.mk
